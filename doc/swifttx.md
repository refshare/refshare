...
This mechanism has been integrated into Bitcore-Node-REFSHARE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/REFSHARE-Project/insight-api-refshare#web-socket-api](https://github.com/REFSHARE-Project/insight-api-refshare#web-socket-api) 
* API: [https://github.com/REFSHARE-Project/insight-api-refshare#swifttx-transactions](https://github.com/REFSHARE-Project/insight-api-refshare#swifttx-transactions) 
...
By default, the REFSHARE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the REFSHARE Core daemon:
