...
In order to support loading of multiple wallets in refshare-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is refshare.cpp.
...
Changes to refshare.cpp
----------------------
refshare.cpp is the entry point into refshare-qt, and as such, will require some minor modifications to provide hooks for
