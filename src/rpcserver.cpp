...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop REFSHARE server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "REFSHARE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* REFSHARE features */
        {"refshare", "fundamentalnode", &fundamentalnode, true, true, false},
        {"refshare", "listfundamentalnodes", &listfundamentalnodes, true, true, false},
        {"refshare", "getfundamentalnodecount", &getfundamentalnodecount, true, true, false},
        {"refshare", "fundamentalnodeconnect", &fundamentalnodeconnect, true, true, false},
        {"refshare", "fundamentalnodecurrent", &fundamentalnodecurrent, true, true, false},
        {"refshare", "fundamentalnodedebug", &fundamentalnodedebug, true, true, false},
        {"refshare", "startfundamentalnode", &startfundamentalnode, true, true, false},
        {"refshare", "createfundamentalnodekey", &createfundamentalnodekey, true, true, false},
        {"refshare", "getfundamentalnodeoutputs", &getfundamentalnodeoutputs, true, true, false},
        {"refshare", "listfundamentalnodeconf", &listfundamentalnodeconf, true, true, false},
        {"refshare", "getfundamentalnodestatus", &getfundamentalnodestatus, true, true, false},
        {"refshare", "getfundamentalnodewinners", &getfundamentalnodewinners, true, true, false},
        {"refshare", "getfundamentalnodescores", &getfundamentalnodescores, true, true, false},
        {"refshare", "fnbudget", &fnbudget, true, true, false},
        {"refshare", "preparebudget", &preparebudget, true, true, false},
        {"refshare", "submitbudget", &submitbudget, true, true, false},
        {"refshare", "fnbudgetvote", &fnbudgetvote, true, true, false},
        {"refshare", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"refshare", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"refshare", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"refshare", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"refshare", "fnbudgetrawvote", &fnbudgetrawvote, true, true, false},
        {"refshare", "fnfinalbudget", &fnfinalbudget, true, true, false},
        {"refshare", "checkbudgets", &checkbudgets, true, true, false},
        {"refshare", "fnsync", &fnsync, true, true, false},
        {"refshare", "spork", &spork, true, true, false},
        {"refshare", "getpoolinfo", &getpoolinfo, true, true, false},
        {"refshare", "mnspork", &mnspork, true, true, false},
        {"refshare", "masternode", &masternode, true, true, false},
        {"refshare", "masternodelist", &masternodelist, true, true, false},
        {"refshare", "getmasternodestatus", &getmasternodestatus, true, true, false},
#ifdef ENABLE_WALLET
        {"refshare", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> refshare-cli " + methodname + " " + args + "\n";
}
