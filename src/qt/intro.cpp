...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("REFSHARE Core"),
     ...
     * override -datadir in the refshare.conf file in the default data directory
     * (to be consistent with refshared behavior)
     */
    if (dataDir != getDefaultDataDirectory())
