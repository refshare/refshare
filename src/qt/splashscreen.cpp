...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("REFSHARE Core");
    ...
    QString copyrightTextREFSHARE = QChar(0xA9) + QString(" 2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The REFSHARE Core developers"));
    ...
    pixPaint.drawText(pixmap.width() - copyrightPaddingLeft, copyrightPaddingTop + 36, copyrightTextREFSHARE);
