...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::REFSHARE);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeVitaeAmount"))
        SoftSetArg("-anonymizerefshareamount", settings.value("nAnonymizeVitaeAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in refshare.cpp during shotdown to also remove the window positions
