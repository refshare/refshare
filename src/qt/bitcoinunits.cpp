...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(REFSHARE);
    unitlist.append(mREFSHARE);
    unitlist.append(uREFSHARE);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case REFSHARE:
        return QString("refshare");
    case mREFSHARE:
        return QString("mrefshare");
    case uREFSHARE:
        return QString::fromUtf8("urefshare");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case REFSHARE:
            return QString("REFSHARE");
        case mREFSHARE:
            return QString("Milli-REFSHARE (1 / 1" THIN_SP_UTF8 "000)");
        case uREFSHARE:
            return QString("Micro-REFSHARE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
