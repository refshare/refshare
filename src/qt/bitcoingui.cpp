...
// Copyright (c) 2015-2017 The REFSHARE developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("REFSHARE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a REFSHARE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and refshare: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zREFSHARE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About REFSHARE Core"), this);
    aboutAction->setStatusTip(tr("Show information about REFSHARE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for REFSHARE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your REFSHARE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified REFSHARE addresses"));
    ...
    openAction->setStatusTip(tr("Open a REFSHARE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the REFSHARE Core help message to get a list with possible REFSHARE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("REFSHARE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to REFSHARE network", "", count));
}
...
{
    QString strTitle = tr("REFSHARE Core"); // default title
