...
/** Utility functions used by the REFSHARE Qt UI.
 */
namespace GUIUtil
{
...
// Render REFSHARE addresses in monospace font
...
// Parse "refshare:" URI into recipient object, return true on successful parsing
