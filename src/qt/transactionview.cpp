 ...
 */
    ...
    typeWidget->addItem(tr("Received REFSHARE from zREFSHARE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zREFSHARE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVit));
