...
#define QAPP_ORG_NAME "REFSHARE"
#define QAPP_ORG_DOMAIN "refshare.org"
#define QAPP_APP_NAME_DEFAULT "REFSHARE-Qt"
#define QAPP_APP_NAME_TESTNET "REFSHARE-Qt-testnet"
