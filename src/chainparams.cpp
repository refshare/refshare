...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8765;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // REFSHARE starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 45; // REFSHARE: 1 day
        nTargetSpacing = 1 * 45;  // REFSHARE: 1 minute
        nMaturity = 8;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("209.182.216.144", "209.182.216.144")); // refshare fn
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("209.182.216.144", "209.182.216.144")); // refshare fn
        vSeeds.push_back(CDNSSeedData("209.182.216.187", "209.182.216.187")); // refshare fn
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet refshare addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet refshare script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet refshare BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet refshare BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet refshare BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // REFSHARE: 1 day
        nTargetSpacing = 1 * 60;        // REFSHARE: 1 minutes
