...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vitae Core refshare-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  refshare-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded refshare transaction") + "\n" +
                               "  refshare-tx [options] -create [commands]   " + _("Create hex-encoded refshare transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded refshare transaction
