...
This means one can have an always-on refshared instance running, and another local refshared/refshare-qt instance which connects to this node and receives blocks from it.
