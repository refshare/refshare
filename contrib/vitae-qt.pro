...
RESOURCES += src/qt/refshare.qrc src/qt/refshare_locale.qrc

TRANSLATIONS += src/qt/locale/refshare_bg.ts \
                src/qt/locale/refshare_de.ts \
                src/qt/locale/refshare_en.ts \
                src/qt/locale/refshare_es.ts \
                src/qt/locale/refshare_fi.ts \
                src/qt/locale/refshare_fr.ts \
                src/qt/locale/refshare_it.ts \
                src/qt/locale/refshare_ja.ts \
                src/qt/locale/refshare_pl.ts \
                src/qt/locale/refshare_pt.ts \
                src/qt/locale/refshare_ru.ts \
                src/qt/locale/refshare_sk.ts \
                src/qt/locale/refshare_sv.ts \
                src/qt/locale/refshare_vi.ts \
                src/qt/locale/refshare_zh_CN.ts \
                src/qt/locale/refshare_zh_TW.ts
