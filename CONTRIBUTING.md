Contributing to REFSHARE Core
============================

The REFSHARE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the REFSHARE Core project, and is not to be
confused with overall REFSHARE Network Protocol consensus changes.

Whether a pull request is merged into REFSHARE Core rests with the project merge
...
Patches that change REFSHARE consensus rules are considerably more involved than
...
Where a patch set proposes to change the REFSHARE consensus, it must have been
...
The project leader is the release manager for each REFSHARE Core release.
